...
<html lang="en">
  <head>
    ...
    <title>pradeep hotel - CONTACT</title>
    ...
    <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 px-lg--0">
      <nav class="navbar navbar-expand-lg bg-light  bg-white rounded shadow">
         ...
         <h4 class="mt-2">FILTERS</h4>
            ...
            <div class="collapse navbar-collapse text-dark flex-column align-items-stretch" id="filterdropdown">
          ...
          <div class="card mb-4 border-0 shadow">
            <div class="row g-0 p-3 align-items-center">
              ...
              <div class="col-md-5 px-lg-3 px-md-3 px-0">
                <h5 class=" mb-3">Simple Room Name
                </h5>
              ...
              <div class="col-md-2 mt-lg-0 mt-md-4 mt-4 text-center">
